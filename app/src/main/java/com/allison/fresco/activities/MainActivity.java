package com.allison.fresco.activities;
...
import com.allison.fresco.fragments.MyRecipesFragment;
import com.allison.fresco.fragments.ShoppingListFragment;
import com.allison.fresco.models.MealPlan;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showFragment(MyRecipesFragment.class);
    }
    ...
    private void selectItem(int position) {
        ...
        if (position == 0) {
            fragment = AddRecipeFragment.class;
            showFragment(fragment);
        } else if (position == 1) {
            fragment = MealPlan.class;
            showFragment(fragment);
        } else if (position == 2) {
            fragment = MyRecipesFragment.class;
            showFragment(fragment);
        } else if (position == 3) {
            fragment = ShoppingListFragment.class;
            showFragment(fragment);
        }
